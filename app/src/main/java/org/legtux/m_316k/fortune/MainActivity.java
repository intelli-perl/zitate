...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.fortuneDisplayer)).setText(fortune.getDirName()+"\n"+this.fortune.current()); //CA debug

        this.nextFortune = (Button) findViewById(R.id.newFortune);
        nextFortune.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fortuneDisplayer.setText(fortune.getDirName()+"\n"+fortune.next(preferences.getBoolean("tldr", false))); //CA debug
